package org.momacmo.aws.lambda.jscio.demo;
...
// Lambda handler for Fanout Worker pattern
public class JscLambdaFanoutWorker implements RequestHandler<Map<String, String>, String> {
  @Override
